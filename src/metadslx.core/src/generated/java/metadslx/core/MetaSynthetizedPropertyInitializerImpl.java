...
class MetaSynthetizedPropertyInitializerImpl extends metadslx.core.ModelObject implements metadslx.core.MetaSynthetizedPropertyInitializer {
    static {
    ...
    public MetaSynthetizedPropertyInitializerImpl() {
        ...
        this.mLazySet(metadslx.core.MetaDescriptor.MetaPropertyInitializer.PropertyProperty, metadslx.core.Lazy.create(() -> ModelCompilerContext.current().getBindingProvider().bind(this, ModelCompilerContext.current().getResolutionProvider().resolve(java.util.Arrays.asList(new metadslx.core.ModelObject[] { (ModelObject)((MetaPropertyInitializer)this).getPropertyContext() }), ResolveKind.Name, ((MetaPropertyInitializer)this).getPropertyName(), new ResolutionInfo(), ResolveFlags.All), new BindingInfo()), true));
        ...
        metadslx.core.MetaImplementationProvider.implementation().MetaSynthetizedPropertyInitializer(this);
        this.mMakeDefault();
    }
